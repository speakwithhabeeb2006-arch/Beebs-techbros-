...
<head>
    ...
    <title>Beebs Techbros</title>
    <meta name="description" content="Beebs Techbros - Futuristic Tech Community & Portfolio">
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            line-height: 1.6;
            overflow-x: hidden;
            background-image: radial-gradient(circle at 50% 50%, #1a1f2e 0%, var(--bg) 100%);
        }
